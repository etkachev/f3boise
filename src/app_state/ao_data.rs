...
impl AO {
    pub fn week_days(&self) -> AoDays {
        match self {
            ...
            AO::Rafo => HashSet::from([Weekday::Fri]),
    ...
    pub fn default_time(&self, week_day: &Weekday) -> Option<NaiveTime> {
        ...
        match week_day {
            ...
            Weekday::Tue => match self {
                AO::BlackCanyon => Some(five_thirty),
                ao if ao.week_days().contains(week_day) => Some(five_fifteen),
                _ => None,
            },
            Weekday::Wed => match self {
            ...
            Weekday::Sun => match self {
                AO::SundayRuck => Some(five_thirty),
                _ => None,
            },
        }
    }
    ...
    pub fn ao_type(&self) -> AoType {
        match self {
            ...
            AO::SundayRuck => AoType::Rucking,
            AO::Rafo => AoType::Rucking,
    ...
    pub fn channel_id(&self) -> &str {
        match self {
            ...
            AO::SundayRuck => const_names::SUNDAY_RUCK_CHANNEL_ID,
            AO::Rafo => const_names::RAFO_CHANNEL_ID,
    ...
    pub fn address(&self) -> Option<&str> {
        match self {
            ...
            AO::OtbGordonHarrisPark => Some("2388 E Three Bars Dr, Meridian, ID 83642"),
    ...
    pub fn real_map_url(&self) -> Option<&str> {
        match self {
            ...
            AO::OtbGordonHarrisPark => Some(const_names::OTB_GORDON_HARRIS_PARK_GOOGLE_MAPS),
    ...
    pub fn from_channel_id(channel_id: &str) -> Self {
        match channel_id {
            ...
            const_names::OTB_GORDON_HARRIS_PARK_CHANNEL_ID => AO::OtbGordonHarrisPark,
...
impl Display for AO {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let name = match self {
            ...
            AO::SundayRuck => const_names::SUNDAY_RUCK,
            AO::Rafo => const_names::RAFO,
            AO::DR => "",
            AO::Unknown(_) => "",
        };
        write!(f, "{}", name)
...
impl From<String> for AO {
    fn from(ao: String) -> Self {
        ...
        match cleaned_ao {
            ...
            const_names::SUNDAY_RUCK => AO::SundayRuck,
            const_names::RAFO => AO::Rafo,
...
fn channel_to_ao_mapper(channel: &PublicChannels) -> AO {
    match channel {
        ...
        PublicChannels::OtbGordonHarrisPark => AO::OtbGordonHarrisPark,
...
pub mod const_names {
    ...
    pub const SENTINELS: &str = "sentinels";
    pub const SENTINELS_CHANNEL_ID: &str = "C08QR6U5W2V";
    pub const SENTINELS_GOOGLE_MAPS: &str = "https://maps.app.goo.gl/vsHikgE7J5Qk6hgE7";
    ...
    pub const OTB_GORDON_HARRIS_PARK: &str = "otb-gordon-harris-park";
    pub const OTB_GORDON_HARRIS_PARK_CHANNEL_ID: &str = "C0A5ZDLFLH4";
    pub const OTB_GORDON_HARRIS_PARK_GOOGLE_MAPS: &str =
        "https://maps.app.goo.gl/md3RNyR5eQcWEtdf6";
