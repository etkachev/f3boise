...
impl From<&AO> for PublicChannels {
    fn from(ao: &AO) -> Self {
        match ao {
            ...
            AO::Sentinels => PublicChannels::Sentinels,
            AO::EmmettGemIsland => PublicChannels::EmmettGemIsland,
            AO::TheEdge => PublicChannels::TheEdge,
            AO::OtbCynthiaMann => PublicChannels::OtbCynthiaMann,
            AO::OtbLibertyPark => PublicChannels::OtbLibertyPark,
            AO::OtbGordonHarrisPark => PublicChannels::OtbGordonHarrisPark,
            AO::OtbRuckershipCanyon => PublicChannels::OtbRuckershipCanyon,
